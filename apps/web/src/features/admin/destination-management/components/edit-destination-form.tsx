...
export function EditDestinationForm({
  ...
  const [isManualLocation, setIsManualLocation] = useState(true); // Default to manual for editing
  ...
  const defaultValues: Partial<destinationUpdateType> = {
    ...
    externalLink: destination.externalLink || "",
                    ...
                    <field.FormItem>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <p className="text-[11px] text-muted-foreground">
                          Current: {field.state.value ? "Image set" : "No image selected"}
                        </p>
                      </div>
                      <field.FormMessage />
                    </field.FormItem>
