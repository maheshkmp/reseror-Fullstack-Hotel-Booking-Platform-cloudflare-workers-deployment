...
import { type PropertyClass } from "core/zod/property-classes.schema";
        ...
        <Command>
          ...
          <CommandGroup className="max-h-[300px] overflow-auto">
            {data?.map((propertyClass:any) => (
              ...
              >
                {propertyClass.thumbnail && (propertyClass.thumbnail.startsWith("http") || propertyClass.thumbnail.startsWith("/")) && (
