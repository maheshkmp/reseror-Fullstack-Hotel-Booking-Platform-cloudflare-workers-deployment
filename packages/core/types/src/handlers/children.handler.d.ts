...
import type { CreateRoute, GetByIdRoute, ListRoute, RemoveRoute, UpdateRoute } from "./routes/children.routes";
...
export declare const getByParentId: APIRouteHandler<GetByParentIdRoute>;
export declare const listWithObjects: APIRouteHandler<ListWithObjectsRoute>;
